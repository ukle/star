...
import me.star.utils.HttpClientUtil;
...
public class ShufazidianService {
    ...
    private static final String TARGET_FILE = "/Users/apple/IdeaProjects/star/star-tools/src/main/resources/sfzd2.html";
    private static final String APPEND_FILE_HEAD = "/Users/apple/IdeaProjects/star/star-tools/src/main/resources/sfzd-before.txt";
    private static final String APPEND_FILE_FOOTER = "/Users/apple/IdeaProjects/star/star-tools/src/main/resources/sfzd-next.txt";
...
//        appendToFile(contents);
     ...
     * @param contents
     */
    private void appendToFile(List<String> contents) throws IOException {
        if (contents.isEmpty()) {
            return;
        }
        ...
        FileInputStream fis = new FileInputStream(APPEND_FILE_HEAD);
        ...
        FileInputStream fis2 = new FileInputStream(APPEND_FILE_FOOTER);
